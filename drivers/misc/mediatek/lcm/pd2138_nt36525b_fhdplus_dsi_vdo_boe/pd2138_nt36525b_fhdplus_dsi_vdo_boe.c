...
#include "pd2138_nt36525b_fhdplus_dsi_vdo_boe_cmd.h"
...
{
	if (lcm_software_id == 0x07)
		return 0x30;
	else
		return 0xFF;
}

struct LCM_DRIVER pd2138_nt36525b_fhdplus_dsi_vdo_boe_lcm_drv = {
	.name = "pd2138_nt36525b_fhdplus_dsi_vdo_boe",
