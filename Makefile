...
#vivo xiejinyang add for display common source library begin
ifdef CONFIG_DRM_MEDIATEK
$(info, "build vivo display code:$(srctree)")
endif
#vivo xiejinyang add for display common source library end
